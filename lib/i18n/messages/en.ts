...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.updatesDescription": "Check for newer Pi runtime, extension and skill versions.",
    "settings.piRuntime": "Pi runtime",
    "settings.latestVersion": "latest {version}",
    "settings.piUpdateAction": "Update Pi runtime",
    "settings.restartRequired": "Restart the server to use it.",
    "settings.checkFailed": "Check failed",
    "settings.notChecked": "Not checked yet",
    "settings.updatesProjectRequired": "Open a project to check",
    ...
    "subagent.stop": "Stop sub-agent",
    "subagent.stopFailed": "Stop failed",
    "subagent.waiting": "Waiting for the sub-agent to start...",
    "subagent.missing": "Sub-agent session is no longer available.",
    ...
    "chat.extensionOtherPlaceholder": "Other answer…",
    ...
    "i18n.openFullscreen": "Open fullscreen",
    "i18n.fullscreenViewer": "Fullscreen viewer",
