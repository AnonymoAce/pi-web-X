...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.updates": "更新",
    "settings.updatesDescription": "检查 Pi 本体、扩展与技能是否有新版本。",
    "settings.piRuntime": "Pi 本体",
    "settings.latestVersion": "最新 {version}",
    "settings.piUpdateAction": "更新 Pi 本体",
    "settings.restartRequired": "重启服务后生效。",
    "settings.checkFailed": "检查失败",
    "settings.notChecked": "尚未检查",
    "settings.updatesProjectRequired": "打开项目后可检查",
    "auth.prompt": "登录后继续使用",
    "auth.password": "密码",
    "auth.logIn": "登录",
    "auth.loggingIn": "正在登录...",
    ...
    "subagent.stop": "停止子代理",
    "subagent.stopFailed": "停止失败",
    "subagent.waiting": "正在等待子代理启动...",
    "subagent.missing": "子代理会话已不存在。",
    ...
    "i18n.openFullscreen": "全屏查看",
    "i18n.fullscreenViewer": "全屏查看器",
