...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.updates": "更新",
    "settings.updatesDescription": "檢查 Pi 本體、擴充功能與技能是否有新版本。",
    "settings.piRuntime": "Pi 本體",
    "settings.latestVersion": "最新 {version}",
    "settings.piUpdateAction": "更新 Pi 本體",
    "settings.restartRequired": "重新啟動服務後生效。",
    "settings.checkFailed": "檢查失敗",
    "settings.notChecked": "尚未檢查",
    "settings.updatesProjectRequired": "開啟專案後可檢查",
    "auth.prompt": "登入後繼續使用",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.loggingIn": "正在登入...",
    ...
    "subagent.stop": "停止子代理",
    "subagent.stopFailed": "停止失敗",
    "subagent.waiting": "正在等待子代理啟動...",
    "subagent.missing": "子代理工作階段已不存在。",
    ...
    "chat.extensionOtherPlaceholder": "其他答案…",
    ...
    "i18n.openFullscreen": "全螢幕檢視",
    "i18n.fullscreenViewer": "全螢幕檢視器",
